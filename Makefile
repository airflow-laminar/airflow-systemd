...
lint-py:  ## lint python with ruff
	python -m ruff check airflow_systemd
	python -m ruff format --check airflow_systemd
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix airflow_systemd
	python -m ruff format airflow_systemd
...
test:  ## run python tests
	python -m pytest -v airflow_systemd/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v airflow_systemd/tests --cov=airflow_systemd --cov-report term-missing --cov-report xml
